        ...
        while ''.join(clos) != word:
            ...
            if ans in word and ans != word and ans != '':
                ...
                if ans == '1':
                    ...
                    if input() == '42':
                        print('Это правильно')
                        print('Kак называется единственный вид спорта, который позволяет вам ударить противника по лицу за то, что он захватил фигуру?')
                        if input() == 'ШАХБОКС':
                            print('Это правильно')
                            print('Сколько раз нужно сложить лист толщиной 0.01мм чтобы закрыть расстояние от Шира до Мордора?')
                            if input() == '38':
                                print('Это правильно')
                                print('Глобальное потепление является следствием того, что с 19 века количество _______ уменьшается')
                                if input() == 'ПИРАТОВ':
                                    print('Это правильно')
